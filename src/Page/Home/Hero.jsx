...
import ProductSelectionArea from "../../components/ProductSelectionArea";

const Hero = () => {
  return (
    <section className="p-4">
      <div className="content bg-[var(--bg-color)] h-screen w-full rounded-[40px]">
        <div className="top-content flex flex-col justify-center items-center">
          ...
          <div className="text">
            <p className="font-light text-[18px] leading-[29px] text-center text-gray-700">
              Agentic AI products that deliver results across projects,
              marketing,
              <br />
        ...
        <div className="bottom-content flex justify-center items-center">
